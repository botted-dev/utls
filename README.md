...
[![Build Status](https://travis-ci.org/botted-dev/utls.svg?branch=master)](https://travis-ci.org/botted-dev/utls)
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/botted-dev/utls#UConn)
---
...
so you are encouraged to use [godoc](https://godoc.org/github.com/botted-dev/utls#UConn).
...
# Client Hello IDs
See full list of `clientHelloID` values [here](https://godoc.org/github.com/botted-dev/utls#ClientHelloID).  
...
1. Import this library (e.g. `import tls "github.com/botted-dev/utls"`)
